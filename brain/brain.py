...
class Brain:
    def __init__(self, config_path: Optional[str] = None):
        ...
        # v6.8 — Listing monitor: tracks new exchange listings for premium arb
        from brain.listing_monitor import ListingMonitor
    ...
    async def start(self) -> None:
        ...
        tasks = [
            ...
            asyncio.create_task(self.listing_monitor.start(),  name="listing_monitor"),
        ]

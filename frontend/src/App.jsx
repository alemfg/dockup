    ...
    <div className="min-h-screen flex flex-col bg-gray-950 text-gray-100">
      ...
      <header className="bg-gray-900 border-b border-gray-800 px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-white tracking-tight">ARBX v4.3</h1>
      ...
      <footer className="border-t border-gray-800 px-6 py-3 text-center text-xs text-gray-700">
        ARBX v4.3 — Graph Config via .env · BF+FW Dual-Run · Per-Exchange Fees · Bybit Worker · Tooltips
      </footer>
    </div>
  )
}

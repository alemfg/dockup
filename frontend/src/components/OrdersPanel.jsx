...
function OpenOrdersSection() {
  ...
  const { sorted, SortTh } = useSortable(orders, 'pair', 'asc')
          ...
          <table className="w-full text-xs">
            <thead className="bg-gray-900 border-b border-gray-800">
              <tr>
                ...
                <SortTh col="side">Side</SortTh>
                <SortTh col="order_type">Type</SortTh>
                <SortTh col="volume">Volume</SortTh>
                <SortTh col="price">Price</SortTh>
                <SortTh col="trading_mode">Mode</SortTh>

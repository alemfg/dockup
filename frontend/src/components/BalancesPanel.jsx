...
export default function BalancesPanel() {
  ...
  const { data: summary, loading: sLoad } = usePolling(fetchBalanceSummary, 10000)
  const { data: balData,  loading: bLoad } = usePolling(fetchBalances, 10000)
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-1">
        ...
        <div className="ml-auto text-lg font-bold text-green-400 flex items-center">

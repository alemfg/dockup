...
function ApiKeysSection() {
  ...
  const { sorted, SortTh } = useSortable(keys, 'exchange', 'asc')
        ...
        <div className="border border-gray-800 rounded-xl overflow-hidden">
          <table className="w-full text-xs">
            <thead className="bg-gray-900 border-b border-gray-800">
              <tr>
                <SortTh col="exchange">Exchange</SortTh>
                <SortTh col="label">Label</SortTh>
                ...
                <SortTh col="sandbox">Mode</SortTh>
...
function FeesSection() {
  ...
  const { sorted, SortTh } = useSortable(fees, 'exchange', 'asc')
        ...
        <div className="border border-gray-800 rounded-xl overflow-hidden">
          <table className="w-full text-xs">
            <thead className="bg-gray-900 border-b border-gray-800">
              <tr>
                <SortTh col="exchange">Exchange</SortTh>
                <SortTh col="taker_pct">Taker %</SortTh>
                <SortTh col="maker_pct">Maker %</SortTh>
                <th className="py-2 px-2"></th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="border border-gray-800 rounded-xl overflow-hidden max-h-96 overflow-y-auto">
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-gray-900 border-b border-gray-800">
              <tr>
                <SortTh col="exchange">Exchange</SortTh>
                <SortTh col="coin">Coin</SortTh>
                <SortTh col="network">Network</SortTh>
                <SortTh col="fee_amount">Fee (coin)</SortTh>
                <SortTh col="fee_usd">Fee (USD)</SortTh>
                <SortTh col="min_amount">Min</SortTh>
              </tr>
            </thead>
            <tbody>
              {sorted.map(f => (

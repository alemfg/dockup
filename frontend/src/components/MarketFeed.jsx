...
export default function MarketFeed() {
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      tip: 'Price updates rejected by the data quality filter: zero prices and cross-unit outliers (e.g. BTC-denominated price stored alongside USDT price). Check /api/market/rejected for details.',
    },
    {
      label: 'Total USD',

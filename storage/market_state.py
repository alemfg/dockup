...
class MarketState:
    ...
    def update_price(
        ...
        # ── Reject statistical outliers (cross-unit mismatches) ───────────────
        # Compare against existing prices for this pair across all exchanges.
        # If the new price deviates by more than _OUTLIER_THRESHOLD× from the
        # median, it's likely in different units (e.g. BTC vs USDT denominated).
    ...
    def get_all_pairs(self) -> List[str]:
        return list({v["pair"] for v in self._prices.values()})

# ArbitrageEngine v2 — Install & Deployment Guide
...
docker pull your-registry/arbitrage-worker:v2
```
...
MAX_WORKERS=5 \
WORKER_IMAGE=arbitrage-worker:v2 \
...
[Unit]
Description=ArbitrageEngine v2 Brain

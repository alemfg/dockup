# ArbitrageEngine v2 — System Description
...
ArbitrageEngine v2 is a professional, distributed, modular crypto arbitrage research and simulation platform. It is designed around one central principle: **the brain should never connect to exchanges directly.**
...
*ArbitrageEngine v2.0.0 — For research and simulation use only.*  

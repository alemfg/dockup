...
# ─── Load config/.env so port overrides work without CLI flags ─────────────
# This makes  BRAIN_API_PORT=8080  in config/.env  just work.
# Priority: CLI arg > config/.env > built-in default below.
-include config/.env
export
...
help:
	@echo ""
	@echo "  ARBX v2 — Available Commands"
	@echo "  ══════════════════════════════════════════════════════════════"
	@echo ""
	@echo "  Setup"
	@echo "  ─────────────────────────────────────────────────────────────"
	...
	@echo "  make docker-worker-logs  Tail binance worker logs"
	@echo ""
	...
	@echo "    PROMETHEUS_PORT     (default 9091)"
	@echo "    GRAFANA_PORT        (default 3001)"
	@echo ""
...
docker-logs:
	docker compose -f docker/docker-compose.yml logs -f brain
...
ports:
	...
	@echo "  Prometheus UI         PROMETHEUS_PORT      $(PROMETHEUS_PORT)"
	@echo "  Grafana               GRAFANA_PORT         $(GRAFANA_PORT)"
	@echo "  ══════════════════════════════════════════════════════════"
